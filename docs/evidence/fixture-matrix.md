...
| Distribution §9 | app/DMG inspection, universal/release scripts, CI packaging | x86 target, clean Intel/M1 host, Developer ID, notarization profile unavailable | blocked |
